...
type CreateChatRequest struct {
	...
	DbName        string                 `protobuf:"bytes,2,opt,name=db_name,json=dbName,proto3" json:"db_name,omitempty"`       // Название базы данных
...
func (x *CreateChatRequest) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
type CreateChatResponse struct {
	...
	DbName        string                 `protobuf:"bytes,3,opt,name=db_name,json=dbName,proto3" json:"db_name,omitempty"`           // Название базы данных
	Message       string                 `protobuf:"bytes,4,opt,name=message,proto3" json:"message,omitempty"`                       // Ответ от сервера
	Status        uint32                 `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`                        // HTTP-статус ответа
	CreatedAt     int64                  `protobuf:"varint,6,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // Время создания сообщения (timestamp)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateChatResponse) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
func (x *AddUsersToChatRequest) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
type AddUsersToChatResponse struct {
	...
	Status        uint32                 `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`  // HTTP-статус ответа
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AddUsersToChatResponse) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
type ChatMessage struct {
	...
	DbName        string                 `protobuf:"bytes,4,opt,name=db_name,json=dbName,proto3" json:"db_name,omitempty"`           // Название базы данных
	...
	Response      string                 `protobuf:"bytes,6,opt,name=response,proto3" json:"response,omitempty"`                     // Ответ от сервера
	Status        uint32                 `protobuf:"varint,7,opt,name=status,proto3" json:"status,omitempty"`                        // HTTP-статус ответа
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChatMessage) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
func (x *ChatMessage) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
func (x *ChatMessage) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ConnectUsersToChat) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
type SaveMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DbName        string                 `protobuf:"bytes,1,opt,name=db_name,json=dbName,proto3" json:"db_name,omitempty"`  // Имя базы данных
	ChatId        int64                  `protobuf:"varint,2,opt,name=chat_id,json=chatId,proto3" json:"chat_id,omitempty"` // ID чата
...
type SaveMessageResponse struct {
	...
	Status        int32                  `protobuf:"varint,6,opt,name=status,proto3" json:"status,omitempty"`                        // HTTP статус
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SaveMessageResponse) Reset() {
	*x = SaveMessageResponse{}
	mi := &file_dbservice_proto_dbchat_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SaveMessageResponse) Descriptor() ([]byte, []int) {
	return file_dbservice_proto_dbchat_proto_rawDescGZIP(), []int{8}
}
...
func (x *SaveMessageResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_dbservice_proto_dbchat_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x66, 0x22, 0x3a, 0x0a, 0x06, 0x55, 0x73, 0x65,
	...
	,
	...
	0x06, 0x64, 0x62, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xc5, 0x01, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x68, 0x61, 0x74, 0x49, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x64, 0x62, 0x5f, 0x6e,
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0x73, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x73, 0x54, 0x6f, 0x43, 0x68, 0x61, 0x74, 0x12, 0x2b, 0x0a, 0x07, 0x55, 0x73,
	0x65, 0x72, 0x73, 0x49, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x66, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x52, 0x07,
	0x55, 0x73, 0x65, 0x72, 0x73, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x74, 0x5f,
	...
	0x09, 0x52, 0x06, 0x64, 0x62, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x79, 0x0a, 0x12, 0x53, 0x61, 0x76,
	...
	0x52, 0x06, 0x64, 0x62, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x74,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0xb7, 0x01, 0x0a, 0x13, 0x53, 0x61, 0x76, 0x65, 0x4d, 0x65, 0x73,
	...
	,
	...
	0x6f, 0x62, 0x75, 0x66, 0x66, 0x2e, 0x53, 0x61, 0x76, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x12, 0x5a, 0x10, 0x2e, 0x2f, 0x64,
	0x62, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x3b, 0x64, 0x62, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70,
...
var file_dbservice_proto_dbchat_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_dbservice_proto_dbchat_proto_goTypes = []any{
	...
	(*ChatMessage)(nil),            // 5: protobuff.ChatMessage
	(*ConnectUsersToChat)(nil),     // 6: protobuff.ConnectUsersToChat
	(*SaveMessageRequest)(nil),     // 7: protobuff.SaveMessageRequest
	(*SaveMessageResponse)(nil),    // 8: protobuff.SaveMessageResponse
}
var file_dbservice_proto_dbchat_proto_depIdxs = []int32{
	...
	1, // 3: protobuff.dbChatService.CreateChat:input_type -> protobuff.CreateChatRequest
	7, // 4: protobuff.dbChatService.SaveMessage:input_type -> protobuff.SaveMessageRequest
	2, // 5: protobuff.dbChatService.CreateChat:output_type -> protobuff.CreateChatResponse
	8, // 6: protobuff.dbChatService.SaveMessage:output_type -> protobuff.SaveMessageResponse
