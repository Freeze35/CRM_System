...
<h3 id="auth"> Сервис авторизации</h3>
...
<h3 id="chats">  Микросервис чатов </h3>
...
<h3 id="timers"> Сервис таймеров</h3>
...
<h3 id="admin_control"> Сервис администрирования </h3>
...
<h3 id="mails"> Сервис отправки писем</h3>
...
---
 ...
 <h3 id="dbsrevice"> Сервис базы данных </h3>
...
<h3 id="logs"> Сервис логирования </h3>
...
2. Аутентификация с помощью JWT
...
3. Управление gRPC-соединениями (Keepalive)
...
5. Защита от паники (Recovery Interceptor)
...
7. Безопасное управление конфигурацией
